      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white">
                My<span className="text-blue-400">TechZ</span>
              </span>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed">
              Your gateway to the best tech opportunities. Connecting talented
              professionals with top companies across India.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-sm text-gray-400">Admissions</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-gray-400">
                <span className="block">support@mytechz.in</span>
              </li>
              <li className="text-sm text-gray-400">
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <span className="text-sm text-gray-500 hover:text-gray-300 cursor-pointer transition-colors">
              Privacy Policy
            </span>
            <span className="text-sm text-gray-500 hover:text-gray-300 cursor-pointer transition-colors">
              Terms of Service
